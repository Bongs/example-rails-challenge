...
class ChargesControllerTest < ActionController::TestCase
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post :create, charge: { amount: @charge.amount, paid: @charge.paid, refunded: @charge.refunded, unique_code: @charge.unique_code }
    end
  ...
  test "should update charge" do
    patch :update, id: @charge, charge: { amount: @charge.amount, paid: @charge.paid, refunded: @charge.refunded, unique_code: @charge.unique_code }
    assert_redirected_to charge_path(assigns(:charge))
  end
